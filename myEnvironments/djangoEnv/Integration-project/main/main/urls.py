...
urlpatterns = [
	# url(r'^', include('apps.integrationProject.urls', namespace = 'integrationProject')),
	url(r'^', include('apps.courses.urls', namespace = 'courses')),
	# url(r'^courses/', include('apps.courses.urls', namespace = 'courses')),
	url(r'^loginRegister/', include('apps.loginRegister.urls', namespace = 'loginRegister')),
	# url(r'^generator/', include('apps.generator.urls', namespace = 'generator')),
